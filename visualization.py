...
def combine_images_to_video(fname_format="iteration\%03d.png", save_file="out.mp4"):
	...
	os.system('ffmpeg -f image2 -r 1/0.1 -i %s -c:v libx264 -pix_fmt yuv420p %s' % (fname_format, save_file))
